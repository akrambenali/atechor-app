...
@Component({
  ...
  templateUrl: './client-data-light-crm-page.component.html',
  styleUrls: ['./client-data-light-crm-page.component.css'],
})
export class ClientDataPageLightCrmComponent implements OnInit {
  RespMessage: any;
  clientData!: Client;
  contactforms = false;
