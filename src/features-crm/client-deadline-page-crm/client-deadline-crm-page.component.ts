...
@Component({
  selector: 'app-client-deadline-crm-page',
  templateUrl: './client-deadline-crm-page.component.html',
  styleUrls: ['./client-deadline-crm-page.component.css'],
})
export class ClientDeadlinePageCrmComponent implements OnInit {
  ...
  pushClientDeadline(newItem: any) {
    ...
    this.isEmpty = false;
    this.goToRoute('crm/reason-client');
  }
