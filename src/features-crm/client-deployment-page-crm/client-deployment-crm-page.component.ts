...
@Component({
  selector: 'app-client-deployment-crm-page',
  templateUrl: './client-deployment-crm-page.component.html',
  styleUrls: ['./client-deployment-crm-page.component.css'],
})
export class ClientDeploymentPageCrmComponent implements OnInit {
  ...
  pushClientinternationnalBusiness(newItem: any) {
    ...
    this.isEmpty = false;
    this.goToRoute('crm/fonctions-client');
  }
