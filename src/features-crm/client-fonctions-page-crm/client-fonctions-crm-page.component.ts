...
@Component({
  selector: 'app-client-fonstions-crm-page',
  templateUrl: './client-fonctions-crm-page.component.html',
  styleUrls: ['./client-fonctions-crm-page.component.css'],
})
export class ClientFonctionsPageCrmComponent implements OnInit {
