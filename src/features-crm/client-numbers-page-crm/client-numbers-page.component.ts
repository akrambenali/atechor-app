...
@Component({
  selector: 'app-client-numbers-crm-page',
  templateUrl: './client-numbers-crm-page.component.html',
  styleUrls: ['./client-numbers-crm-page.component.css'],
})
export class ClientNumbersPageCrmComponent implements OnInit {
  ...
  pushUsersNumber(newItem: any) {
    ...
    this.isEmpty = false;
    this.goToRoute('crm/hosting-client');
  }
