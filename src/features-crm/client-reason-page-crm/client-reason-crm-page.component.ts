...
@Component({
  selector: 'app-client-reason-crm-page',
  templateUrl: './client-reason-crm-page.component.html',
  styleUrls: ['./client-reason-crm-page.component.css'],
})
export class ClientReasonPageCrmComponent implements OnInit {
  ...
  pushReasonDev(newItem: any) {
    const found = this.reason.some((el: { value: any }) => el.value === newItem.value);
    if (!found) {
