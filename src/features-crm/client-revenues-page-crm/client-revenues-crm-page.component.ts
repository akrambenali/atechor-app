...
@Component({
  selector: 'app-client-revenues-crm-page',
  templateUrl: './client-revenues-crm-page.component.html',
  styleUrls: ['./client-revenues-crm-page.component.css'],
})
export class ClientRevenuesPageCrmComponent implements OnInit {
  ...
  pushClientRevenues(newItem: any) {
    ...
    this.isEmpty = false;
    this.goToRoute('crm/users-client');
  }
