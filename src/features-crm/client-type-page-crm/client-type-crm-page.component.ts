...
@Component({
  ...
  templateUrl: './client-type-crm-page.component.html',
  styleUrls: ['./client-type-crm-page.component.css'],
})
export class ClientTypePageCrmComponent implements OnInit {
  ...
  pushClientType(newItem: any) {
    ...
    this.isEmpty = false;
    this.goToRoute('crm/revenue-client');
  }
