...
@Component({
  selector: 'app-result-crm-page',
  templateUrl: './result-crm-page.component.html',
  styleUrls: ['./result-crm-page.component.css'],
})
export class ResultPageCrmComponent implements OnInit {
  id: any;
  result: any;
  history: any;
  secteur: string[] = [];
