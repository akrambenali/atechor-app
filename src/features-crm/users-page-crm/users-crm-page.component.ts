...
@Component({
  selector: 'app-users-crm-page',
  templateUrl: './users-crm-page.component.html',
  styleUrls: ['./users-crm-page.component.css'],
})
export class UsersPageCrmComponent implements OnInit {
  ...
  pushClientCompanySize(newItem: any) {
    ...
    this.isEmpty = false;
    this.goToRoute('crm/deploiment-client');
  }
